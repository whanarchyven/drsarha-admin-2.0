      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <div className="bg-[#EEEAF3] rounded-lg shadow-md p-8 w-full max-w-md">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">Введите данные для входа в систему</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-2">
              <Button type="submit" className="w-full bg-[#0A2A7A] hover:bg-[#0A2A7A]/90 text-white">
                Войти
              </Button>
            </div>

            <div className="text-center text-sm">
              <Link href="/forgot-password" className="text-[#0A2A7A] hover:underline">
                Забыли пароль?
              </Link>
            </div>
          </form>
