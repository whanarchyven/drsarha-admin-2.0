...
import { Eye, EyeOff, Lock, Pencil, Trash2, Check, Mail, Phone, Send } from "lucide-react"
...
export default function AnketsTable({ initialAnkets }: AnketsTableProps) {
  ...
  return (
    <>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="sticky right-0 bg-white z-10 w-[120px]">Действия</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {ankets.length === 0 ? (
      ...
      />
      <ConfirmationDialog type="success" title="Подтвердить"
