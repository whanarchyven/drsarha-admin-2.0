    ...
    setUsers(
      users.map((user) =>
        user._id === selectedUser._id
          ? { ...user, ...(editedUser as unknown as User) }
          : user
      )
    );
    setActiveDialog(null);
    ...
    <>
      <div className="w-full overflow-auto">
        <div className="flex justify-between items-center">
          ...
          <Button variant={'cPrimary'} onClick={() => openDialog('create')}>
            ...
            {users.length === 0 ? (
              ...
              users.map((user) => (
                <TableRow key={user._id}>
                  ...
                  <TableCell>
                    {RoleType[user.role as keyof typeof RoleType]}
                  </TableCell>
      ...
      <Dialog
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Введите новый пароль для пользователя {selectedUser?.email}
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                onValueChange={(value) =>
                  setCreateForm({ ...createForm, role: value as RoleType })
                }>
                <SelectTrigger>
